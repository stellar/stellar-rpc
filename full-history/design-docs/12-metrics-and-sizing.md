...
| Chunks per index                                                  | 1,000              | = RangeSize (10M) ÷ ChunkSize (10K)                                                     |
...
| Max parallel index orchestrators                                  | 2                  | `[backfill].workers`                                                                    |
...
| `chunks_per_index` config default                                 | 1,000              | `[backfill].chunks_per_index`; must equal RangeSize ÷ ChunkSize                         |
