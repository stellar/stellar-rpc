...
require (
	...
	// v2.18.2 is the minimum (the FastOr/runContainer16 fix, #527).
	// v2.26.0 adds vectorized container kernels behind x/sys/cpu and
	// GODEBUG gates; the aggregation layer is unchanged since v2.18.
