...
### Added
- Added `--backfill` configuration parameter providing synchronous backfilling of `history_archive_window` ledgers to the local DB prior to RPC starting ([#571](https://github.com/stellar/stellar-rpc/pull/571)).
