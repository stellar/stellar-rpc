...
// frozen pack covers its whole chunk. Entry.Bytes follows the stores' borrow
// contract: valid only until the loop body ends, whether that is the next
// iteration step or a break — copy it to retain it.
//
