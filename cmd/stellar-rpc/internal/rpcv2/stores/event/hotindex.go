...
func (h *HotIndex) ApplyLedger(seq uint32, rowBytes []byte, perKeyIDs map[events.TermKey][]uint32) error {
...
func (h *HotIndex) Get(term events.TermKey) (*roaring.Bitmap, error) {
