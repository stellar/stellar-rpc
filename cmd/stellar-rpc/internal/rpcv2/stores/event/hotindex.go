...
//     their roaring bitmaps in the existing ConcurrentBitmaps — popular-term
//     queries stay memory-fast.
...
const (
	...
	// ledger brings it at least this many event. Firehose terms (every
...
func fp64(term TermKey) uint64 { return xxhash.Sum64(term[:]) }
