...
// missing, unreadable, or failing at the operating-system level. Everything
// else an artifact reader returns (a bad magic number, a truncated record, a
// failed checksum, a foreign format, offsets that do not add up) describes
// the bytes that are there, and is recorded as a mismatch.
