...
type datastoreInfo struct {
	...
	sequences sqlitedb.LedgerSeqRange // holds the sequence numbers of the oldest and current tip ledgers in the datastore
}
...
type databaseInfo struct {
	...
	sequences sqlitedb.LedgerSeqRange // holds the sequence numbers of the oldest and newest ledgers in the local database
	isNewDb   bool
}

type fillBounds struct {
	backfill          sqlitedb.LedgerSeqRange
	frontfill         sqlitedb.LedgerSeqRange
	nBackfill         uint32
...
func NewBackfillMeta(
	...
	return BackfillMeta{
		...
		dbInfo: databaseInfo{
			reader: reader,
			sequences: sqlitedb.LedgerSeqRange{
