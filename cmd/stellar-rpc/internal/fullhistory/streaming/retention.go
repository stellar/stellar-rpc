...
// HIGHER of the two. The signed slidingChunk math is the underflow guard: a
// young store or a large retentionChunks drives slidingChunk negative, which
// max(..., 0) clamps to chunk 0 before mapping to its first ledger.
