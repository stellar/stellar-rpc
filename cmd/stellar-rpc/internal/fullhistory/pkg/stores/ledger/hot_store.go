...
func (h *HotStore) FirstSeq() (seq uint32, ok bool, err error) { return h.edgeSeq(false) }

// LastSeq returns the highest ledger sequence in the store, or ok=false
// if the store is empty.
func (h *HotStore) LastSeq() (seq uint32, ok bool, err error) { return h.edgeSeq(true) }
