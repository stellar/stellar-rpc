...
func TestColdReader_LookupHitAndMiss(t *testing.T) {
	...
	_, err = r.Lookup(randHash(testRNG(0xbeef_face)))
...
func TestColdReader_ConcurrentLookups(t *testing.T) {
	// Many goroutines hammering Lookup on one reader must all see
