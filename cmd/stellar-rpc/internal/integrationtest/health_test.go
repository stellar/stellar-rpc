...
func TestHealth(t *testing.T) {
	...
	assert.Positive(t, result.LatestLedgerCloseTime) //nolint:testifylint // unnecessary whining
	assert.Positive(t, result.OldestLedgerCloseTime) //nolint:testifylint // unnecessary whining
